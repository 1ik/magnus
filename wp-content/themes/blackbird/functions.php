...
function blackbird_enqueue_style_library() {
    wp_register_style('style-library', get_template_directory_uri() . '/css/animate.css' , array(), '21033242', 'all');
    wp_register_style('custom-style', get_template_directory_uri() . '/css/custom.css' , array(), '21033242', 'all');
    wp_enqueue_style('style-library');
    wp_enqueue_style('custom-style');
}

add_action('wp_enqueue_scripts', 'blackbird_enqueue_style_library');
?>